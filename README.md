...
A 1.21 mod that adds Obamium and More to Minecraft! Built from [Modding by Kaupenjoe](https://www.youtube.com/watch?v=eFofdJ1BYYs&list=PLKGarocXCE1GspJBXQEGuhazihZCSSLmK)  
...
<img width="400" alt="Bushium Ore" src="https://github.com/user-attachments/assets/b2ed3b29-1596-44a0-a15b-d7e471ac3d85" />

![bushiunm_ore](https://github.com/user-attachments/assets/fc64cb08-6beb-49a2-b82c-de7d0bb94ea1)

## Obamium Gem
- dropped from the Obamium Ore
- is used in a crafting recipe

![obamium_gem](https://github.com/user-attachments/assets/bbda9ed1-7d0c-4443-838a-01723c219bae)

## Bidenite Gem
- dropped from the Block of Obamium
- is used in a crafting recipe

![bidenite_item](https://github.com/user-attachments/assets/b779b0a9-c5b7-41e2-8e8b-5481ce2491e2)

## Bushium Gem
- dropped from the Bushium Ore
- is used in a crafting recipe  

![bushium_spin](https://github.com/user-attachments/assets/34f5a028-f4aa-42bb-835d-510b5c0a5774)

## Super Obamium Block
- crafted from 8 obamium gems and 1 nether star
- when right clicked, it smites every entity that is not you in a 20 block radius

<img width="400" alt="super obamium crafting recipe" src="https://github.com/user-attachments/assets/d35a03fc-dffa-483e-8e5c-bec8d3a0573a" />
...
## Biden Blast
- crafted from 4 bidenite gems, 4 firework stars, and one nether star
...
<img width="400" alt="screenshoot 2025-01-28 at 4 08 45 PM" src="https://github.com/user-attachments/assets/9342403a-46de-4f48-a50a-28c9962aad57" />
...
## Bushium Prime
- crafted from 4 bushium gems and one nether star
- when right clicked, it gives the player different buffs for 20 seconds

<img width="400" alt="bushium prime item" src="https://github.com/user-attachments/assets/741c5a55-720f-45e5-b8ae-74e21159f16d" />
<img width="400" alt="bushium prime crafting recipe" src="https://github.com/user-attachments/assets/50acda43-d85f-420c-ad05-954f2da19ca8" />

![buffs](https://github.com/user-attachments/assets/d59e1536-8b36-480b-be4a-704198db268d)